        ...
        <p>
          <ol>
            <li>
              ...
              <br />
              Тут ви знайдете офіційно затверджений порядок надання домедичної
              допомоги постраждалим при термічних опіках. Цей опис включає в
              себе оцінку пошкоджень, послідовність дій для надання першої
              допомоги, методи та процедури, необхідні для накладання пов
              &apos;язок та забезпечення належної медичної допомоги тим, хто
              постраждав від теплових ушкоджень.
              <br /> <br />
            ...
            <li>
              <b>Headway | War Manual</b> <br />
              Поради за офіційними інструкціями МОЗ, ДСНС, Центру стратегічних
              комунікацій та інших офіційних джерел інформації, оформлені в
              інфографіки, якими зручно користуватися офлайн. <br /> <br />
              <a href="https://warmanual.makeheadway.com">Відкрити</a>
              <br />
              <br />
            </li>
          </ol>
