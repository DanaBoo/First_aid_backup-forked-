...
function AlgorithmPage() {
  return (
    <div className="algorithm-page">
      ...
      >
        <h1>
          Порядок надання домедичної допомоги постраждалим при термічних опіках{" "}
        </h1>
        <p>
          На цій сторінці ви знайдете покроковий алгоритм надання домедичної
          допомоги при опіках. <br /> Термічні опіки можуть виникнути в
          результаті дії тепла, рідин, пару або вогню на шкіру. <br /> Надання
          належної допомоги в найкоротший час може допомогти зменшити тяжкість
          опіків та сприяти швидкому одужанню.
        </p>{" "}
      </motion.div>
